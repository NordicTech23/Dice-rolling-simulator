...
# setting the background color of our application to light green
root.configure(background = 'light green')

# adding label into the frame
BlankLine = tkinter.Label(root, text = "", bg = 'light green')
BlankLine.pack()

# adding label with different font and formatting
HeadingLabel = tkinter.Label(root, text = "Click the button below to roll the dice",
	fg = "yellow",
	bg = "red",
